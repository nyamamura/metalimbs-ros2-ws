...
xacro src/metalimbs_description/robot/metalimbs2_ign_corrected.urdf.xacro mesh_path:="file://${WORKSPACE_DIR}/src/metalimbs_description/meshes/metalimbs2" > /tmp/metalimbs2_gazebo.urdf
...
cat > /tmp/metalimbs_world.sdf << EOF
<?xml version="1.0" ?>
<sdf version="1.8">
  <world name="default">
    ...
    <include>
      <uri>file:///tmp/metalimbs2_gazebo.sdf</uri>
      <name>metalimbs</name>
...
echo "World file created at /tmp/metalimbs_world.sdf"

# Launch Ignition Gazebo with the world file
echo "Launching Ignition Gazebo with Metalimbs robot..."
ign gazebo -v 4 /tmp/metalimbs_world.sdf